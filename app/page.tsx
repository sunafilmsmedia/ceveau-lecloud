        ...
        <section className="relative overflow-hidden pt-16 pb-8 sm:pt-24">
          ...
          <div className="relative mx-auto max-w-3xl px-5 text-center">
            <span className="inline-flex items-center gap-2 rounded-md border border-fluo-400/25 bg-fluo-500/[0.07] px-4 py-1.5 text-xs font-600 uppercase tracking-widest text-fluo-300">
              Diagnostic IA gratuit · 2 minutes
            </span>
            <h1 className="mx-auto mt-6 font-display text-4xl font-800 leading-[1.08] text-white sm:text-5xl">
              Découvre combien ton entreprise <span className="accent">perd</span> à faire{" "}
              à la main ce que l&apos;IA peut faire.
            </h1>
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-mist-soft">
              Réponds à 7 questions. On te calcule les heures et l&apos;argent récupérables chaque
              année, tes 3 employés IA prioritaires et ton plan d&apos;implantation sur 90 jours.
            </p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-mist-soft">
              ...
              <span className="flex items-center gap-2">
                <span className="inline-block h-1.5 w-1.5 rounded-full bg-fluo-400" /> Résultat
                instantané
              </span>
              <span className="flex items-center gap-2">
